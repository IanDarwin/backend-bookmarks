...
* AND copy META-INF/persistence.xml.sample to META-INF/persistence.xml
** If you miss these steps you will get "no datasource" or "missing database table" messages!
